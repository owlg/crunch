...
output += "\">";
output += runtime.suppressValue(runtime.memberLookup((t_4),"tableid"), env.opts.autoescape);
output += "</a></td>\n                <td><a href=\"#browser\" class=\"drop-table text-danger\" data-tableid=\"";
output += runtime.suppressValue(runtime.memberLookup((t_4),"tableid"), env.opts.autoescape);
output += "\">DROP</a></td>\n            </tr>\n            ";
;
}
